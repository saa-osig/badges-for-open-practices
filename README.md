...
The aim of the project is to recognise archaeologists' efforts to improve scholarly communication in archaeology by making their data, code and other research products openly available. This is an un-official, voluntary project by SAA members. Archaeologists are welcome to opt-in to apply for badges for their conference presentations. Badges are optional, and you should only apply for one it if your work is at a point where you feel ready and comfortable to share your materials. We recognise that conference presentations often include works-in-progress and unpublished materials, and there may be a risk of other people misappropriating your work to gain priority over publication. This badge process can reduce this risk because it provides a DOI and a definitive date-stamp for your work, clearly establishing the priority of your research, and making it citable by others. Our recommendation is to apply for badges for material that is already published, or materials that you feel have a low risk of misappropriation. 
...
To qualify for the badges, your poster/slides/paper must include a **disclosure statement**. The [Center for Open Science](https://osf.io/tvyxz/wiki/2.%20Awarding%20Badges/) require two items in this statement.
